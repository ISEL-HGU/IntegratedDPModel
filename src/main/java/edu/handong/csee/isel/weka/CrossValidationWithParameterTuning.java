...
public class CrossValidationWithParameterTuning implements Runnable{
	int idx;
...
//	static int indexOfLabel;
	...
	public CrossValidationWithParameterTuning(final int idx, final ArrayList<String> filePathList, final String sourcePath, final String dataUnbalancingMode,
