...
if __name__ == '__main__':
    train_filename = '/home/eunjiwon/Git/Collect-Data-with-BugPatchCollector/TrainData/incubator-hivemall_AllCommitsAddedLines.txt'
    ...
    with open("/home/eunjiwon/Git/Collect-Data-with-BugPatchCollector/Output/DP/incubator-hivemall-reference/incubator-hivemall_developer.csv",'r') as csvinput:
        with open("/home/eunjiwon/Git/EJTool/Ngram/nglp_csv/incubator-hivemall_Add_SNGLP_metric.csv", 'w') as csvoutput:
            ...
            for row in reader:
                ...
                testcommit_name = "/home/eunjiwon/Git/Collect-Data-with-BugPatchCollector/TrainData/Commit/incubator-hivemall/" + commit_hash_key + ".txt"
