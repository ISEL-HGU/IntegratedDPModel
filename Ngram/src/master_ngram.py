...
if __name__ == '__main__':
    project_list = ["ant-ivy", "bval", "cayenne", "deltaspike", "gora", "guacamole-client", "incubator-hivemall"]
    for project_name in project_list:
        ...
        with open("/home/eunjiwon/Git/Collect-Data-with-BugPatchCollector/Output/DP/label_DP/" + project_name + "_developer.csv",'r') as csvinput:
            with open("/home/eunjiwon/Git/SoftwareDefectPredictionMetricUsingDeepLearning/data/test/" + project_name + "_Master_NGLP_Metric.csv", 'w+') as csvoutput:
